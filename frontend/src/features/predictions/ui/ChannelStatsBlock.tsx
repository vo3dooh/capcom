            ...
            <StatItem
                ...
                meta={
                    <button type="button" className={styles.roiStatusButton} aria-label="Стиль волатильности канала">
                        ...
                        <span className={styles.roiTooltip} role="tooltip">
                            Уровень стиля ставок отражает степень агрессивности стратегии на основе текущей волатильности. Он характеризует допустимый уровень риска и амплитуду возможных отклонений капитала.
                        </span>
                    </button>
                }
                helpText={
